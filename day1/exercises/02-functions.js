...
// TODO:
const allNames = products.map((product) => product.name); // thay null bằng code của bạn
...
// TODO:
const techInStock = products.filter((product) => product.inStock && product.category === "tech");
...
// TODO:
const sortedByPrice = [...products].sort((product1, product2) => product1.price - product2.price);
